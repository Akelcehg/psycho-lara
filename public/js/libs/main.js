...
function initialize() {
  var stylez = [{
    ...
    "stylers": [{ "weight": 0.1 }, { "saturation": -15 }, { "lightness": 38 }, { "hue": "#0055ff" }, { "gamma": 1.91 }, { "visibility": "on" }, { "color": "#f7f6f7" }]
  }, {
    "featureType": "poi",
    "elementType": "geometry",
    ...
    "featureType": "transit.station",
    "elementType": "labels.icon",
    "stylers": [{ "hue": "#2a00ff" }, { "saturation": -44 }, { "lightness": 3 }, { "gamma": 0.33 }, { "weight": 0.1 }]
  }, {}];
...
function carousel_init(url) {
  jQuery("." + url + "").each(function () {
    jQuery(this).owlCarousel({
      itemsCustom: [[0, 1], [738, 1], [980, 1], [1170, 1]],
      navigation: false,
      slideSpeed: 700,
      pagination: false
    });
...
$(document).ready(function () {
  ...
  jQuery(owl_three).each(function () {
    jQuery(this).owlCarousel({
      itemsCustom: [[0, 1], [479, 2], [738, 2], [980, 3], [1170, 3]],
      navigation: false,
      pagination: false
    });
    var owl = $(this);
  ...
  jQuery(owl_three).each(function () {
    jQuery(this).owlCarousel({
      itemsCustom: [[0, 1], [479, 2], [980, 2], [1170, 2]],
      margin: 40,
      navigation: false,
      pagination: false
    });
  ...
  jQuery(owl_widget).each(function () {
    jQuery(this).owlCarousel({
      itemsCustom: [[0, 3], [738, 3], [980, 3], [1170, 3]],
      navigation: true,
      navigationText: false,
      pagination: false
    });
  ...
  jQuery(owl_four).each(function () {
    jQuery(this).owlCarousel({
      itemsCustom: [[0, 1], [479, 2], [980, 3], [1170, 4]],
      navigation: false,
      pagination: false
    });
    var owl = $(this);

			...
			<div class="grid-col grid-col-9">
				<main>
					...
					<div class="blog-post"><article>
						...
						<h3>Nunc sed urna est. Suspendisse pulvinar arcu vel volutpat imperdiet nisi dolor viverra est</h3>
						<p>Fusce eu tellus ut metus imperdiet molestie. Nunc dapibus lorem eget rutrum ultricies. Nam pretium accumsan ultricies. Etiam viverra pellentesque dui a feugiat.eros sem in dui. In eu sagittis metus. Proin consectetur suscipit dui sed euismod.Nam non metus in est vehicula vestibulum et vel neque. Ut eu arcu at lectus tincidunt dignissim. Sed viverra at tortor sed commodo. Nam vel nibh bibendum lorem imperdiet euismod.<br/><br/>Maecenas bibendum justo vel nunc consequat, vitae convallis nunc posuere. Proin quis elementum. Donec in dolor tincidunt, consequat odio sed, vulputate leo. In porttitor turpis eget sapien consequat, in euismod dui luctus. Praesent ornare sollicitudin magna. Vestibulum volutpat est neque, in rutrum mi interdum quis. Praesent dictum rhoncus luctus. Pellentesque non arcu vel metus ultrices rhoncus eget accumsan purus.</p>
						<div class="tags-post">
							<a href="#" rel="tag">Online Materials</a><!-- 
						 --><a href="#" rel="tag">Featured, Education</a>
						</div>
					...
					<div class="blog-post"><article>
						...
						<h3>Morbi in tincidunt augue. Nunc semper lectus vitae odio interdum convallis.</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lobortis, nunc id sollicitudin vulputate, tortor eros egestas ligula, at ullamcorper massa orci eget mi. Nam iaculis neque ipsum, quis adipiscing nunc hendrerit vel. Aenean sem nisl, eleifend vitae nunc at, fringilla posuere arcu. Fusce eu tellus ut metus imperdiet molestie.</p>
						<div class="tags-post">
							<a href="#" rel="tag">Online Materials</a><!-- 
						 --><a href="#" rel="tag">Featured, Education</a>
						</div>
					...
					<div class="blog-post"><article>
						...
						<h3>Etiam dictum molestie nibh sed mattis. Praesent auctor adipiscing dui quis hendrerit.</h3>
						<p>Donec in dolor tincidunt, consequat odio sed, vulputate leo. In porttitor turpis eget sapien consequat, in euismod dui luctus. Praesent ornare sollicitudin magna. Vestibulum volutpat est neque, in rutrum mi interdum quis. Praesent dictum rhoncus luctus. Pellentesque non arcu vel metus ultrices rhoncus eget accumsan purus.</p>
						<div class="tags-post">
							<a href="#" rel="tag">Online Materials</a><!-- 
						 --><a href="#" rel="tag">Featured, Education</a>
						</div>
					...
					<div class="blog-post"><article>
						...
						<h3>Maecenas viverra nisl in semper consectetur. Ut tristique eu enim vitae venenatis.</h3>
						<p>Proin euismod tortor rutrum purus porta imperdiet. Pellentesque vitae metus in lorem posuere sagittis. Fusce eu tellus ut metus imperdiet molestie. Nunc dapibus lorem eget rutrum ultricies. Nam pretium accumsan ultricies. Etiam viverra pellentesque dui a feugiat.eros sem in dui. In eu sagittis metus. Proin consectetur suscipit dui sed euismod.</p>
						<div class="tags-post">
							<a href="#" rel="tag">Online Materials</a><!-- 
						 --><a href="#" rel="tag">Featured, Education</a>
						</div>
					...
					<div class="blog-post"><article>
						...
						<div class="quotes clear-fix">
							...
							<q><b>Vestibulum et metus a tellus sagittis</b><br/>
								Praesent sagittis magna nec neque viverra lobortis. Quisque tincidunt tortor ac nisl elementum, a ongue dui vestibulum Sed nisl nisl, faucibus non eros ac, posuere pulvinar sem. Quisque volutpat tortor nec malesuada ullamcorper donec a elit non elit vehicula fermentum.
							</q>
						</div>
						<br/>
						<div class="tags-post">
